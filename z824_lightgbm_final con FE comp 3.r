...
PARAM$input$training <- c(201901, 201902, 201903, 201904, 201905, 201906, 201907, 201908,
                          201909, 201910, 201911, 201912, 202001, 202002, 202003, 202004,
                          202005, 202006, 202007,202008, 202009, 202010, 202011, 202012, 
                          202101, 202102, 202103, 202104, 202105,202106,202107)

PARAM$finalmodel$semilla <- 364747

# hiperparametros intencionalmente NO optimos
PARAM$finalmodel$optim$num_iterations <- 1439
PARAM$finalmodel$optim$learning_rate <- 0.0243480586074952
PARAM$finalmodel$optim$feature_fraction <- 0.613887037221037
PARAM$finalmodel$optim$min_data_in_leaf <- 19201
PARAM$finalmodel$optim$num_leaves <- 543
PARAM$finalmodel$optim$neg_bagging_fraction <- 0.204495126861913
